...
class RoutingStatePoolTest {
            ...
            fun create(routing: Routing<Configuration>, nbNodes: Int, viewActivationMode: ActivationMode): ConfigurationTestHelper {
                val nodes = MutableList(nbNodes) { i ->
                    mock<Node<Nothing>> {
                        ...
                        on { toString() } doReturn "Node #$i of ${routing.state}"
                    }
                }
    ...
    fun setUp() {
        val routingPermanent1 = Routing(identifier = Identifier("Permanent 0"), state = Permanent1 as Configuration)
        val routingPermanent2 = Routing(identifier = Identifier("Permanent 1"), state = Permanent2 as Configuration)
        val routingContentViewParented1 = Routing(identifier = Identifier("Content 0"), state = ContentViewParented1 as Configuration)
        val routingContentViewParented2 = Routing(identifier = Identifier("Content 1"), state = ContentViewParented2 as Configuration)
        val routingContentViewParented3 = Routing(identifier = Identifier("Content 2"), state = ContentViewParented3 as Configuration)
        val routingContentExternal1 = Routing(identifier = Identifier("Content 3"), state = ContentExternal1 as Configuration)
        val routingContentExternal2 = Routing(identifier = Identifier("Content 4"), state = ContentExternal2 as Configuration)
