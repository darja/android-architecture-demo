...
class RootBuilder(dependency: ParentComponent) :
    ...
    abstract class Module {
        ...
        @Binds
        abstract fun introListener(interactor: RootInteractor): IntroBuilder.Listener
        ...
        companion object {
            ...
            internal fun router(
                ...
                return RootRouter(
                    ...
                    interactor = interactor,
                    component = component,
                    introBuilder = IntroBuilder(component),
                    verificationFinishedBuilder = VerificationFinishedBuilder(component)
                )
            }
        }
    }
    ...
    interface Component : InteractorBaseComponent<RootInteractor>,
        ...
        VerificationFinishedBuilder.ParentComponent {
